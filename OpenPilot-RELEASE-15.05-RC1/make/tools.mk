...
ifeq ($(UNAME), Linux)
    ifeq ($(ARCH), x86_64)
        ...
        QT_SDK_URL  := http://download.qt.io/archive/qt/5.4/5.4.1/qt-opensource-linux-x64-5.4.1.run
        QT_SDK_MD5_URL := http://download.qt.io/archive/qt/5.4/5.4.1/qt-opensource-linux-x64-5.4.1.run.md5
        QT_SDK_ARCH := gcc_64
    else
        ARM_SDK_URL := https://launchpad.net/gcc-arm-embedded/4.9/4.9-2014-q4-major/+download/gcc-arm-none-eabi-4_9-2014q4-20141203-linux.tar.bz2
        ARM_SDK_MD5_URL := https://launchpad.net/gcc-arm-embedded/4.9/4.9-2014-q4-major/+download/gcc-arm-none-eabi-4_9-2014q4-20141203-linux.tar.bz2/+md5
        QT_SDK_URL  := http://download.qt.io/archive/qt/5.4/5.4.1/qt-opensource-linux-x86-5.4.1.run
        QT_SDK_MD5_URL := http://download.qt.io/archive/qt/5.4/5.4.1/qt-opensource-linux-x86-5.4.1.run.md5
        QT_SDK_ARCH := gcc
    endif
    ...
    QT_SDK_URL  := http://download.qt.io/archive/qt/5.4/5.4.1/qt-opensource-mac-x64-clang-5.4.1.dmg
    QT_SDK_MD5_URL := http://download.qt.io/archive/qt/5.4/5.4.1/qt-opensource-mac-x64-clang-5.4.1.dmg.md5
    ...
    QT_SDK_URL     := http://download.qt.io/archive/qt/5.4/5.4.1/qt-opensource-windows-x86-mingw491_opengl-5.4.1.exe
    QT_SDK_MD5_URL := http://download.qt.io/archive/qt/5.4/5.4.1/qt-opensource-windows-x86-mingw491_opengl-5.4.1.exe.md5
...
# GTEST_URL := https://github.com/google/googletest/archive/release-1.6.0.zip
GTEST_URL := ftp://ftp.free.org/mirrors/rsync.frugalware.org/frugalware-1.9/source/devel-extra/gtest/gtest-1.6.0.zip

ARM_SDK_DIR    := $(TOOLS_DIR)/gcc-arm-none-eabi-4_9-2014q4
QT_SDK_DIR     := $(TOOLS_DIR)/qt-5.4.1
UNCRUSTIFY_DIR := $(TOOLS_DIR)/uncrustify-0.60
DOXYGEN_DIR    := $(TOOLS_DIR)/doxygen-1.8.3.1
# GTEST_DIR      := $(TOOLS_DIR)/googletest-release-1.6.0
...
define GTEST_DOWNLOAD_TEMPLATE
...
define UNCRUSTIFY_INSTALL_TEMPLATE
...
define DOXYGEN_INSTALL_TEMPLATE
...
$(eval $(call UNCRUSTIFY_INSTALL_TEMPLATE,uncrustify,$(UNCRUSTIFY_BUILD_DIR),$(UNCRUSTIFY_URL),,$(notdir $(UNCRUSTIFY_URL)),$(UNCRUSTIFY_BUILD_TEMPLATE),$(UNCRUSTIFY_CLEAN_TEMPLATE)))
...
$(eval $(call DOXYGEN_INSTALL_TEMPLATE,doxygen,$(DOXYGEN_BUILD_DIR),$(DOXYGEN_URL),,$(notdir $(DOXYGEN_URL)),$(DOXYGEN_BUILD_TEMPLATE),$(DOXYGEN_CLEAN_TEMPLATE)))
...
$(eval $(call GTEST_INSTALL_TEMPLATE,gtest,$(GTEST_DIR),$(GTEST_URL),,$(notdir $(GTEST_URL))))
...
openocd_git_win_install: openocd_win_clean libusb_win_install ftd2xx_install
	...
	$(V1) ( \
	  ...
	  ./configure --enable-maintainer-mode --prefix="$(OPENOCD_WIN_DIR)" \
		--build=i686-pc-linux-gnu --host=i5.6-mingw32msvc \
